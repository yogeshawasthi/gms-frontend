...
const MemberDetail = () => {
  ...
  const fetchMembership = async () => {
    axios.get(`${process.env.REACT_APP_API_URL}/plans/getMembership`, { withCredentials: true })
      .then((response) => {
  ...
  const fetchData = async () => {
    ...
    await axios
      .get(`${process.env.REACT_APP_API_URL}/members/get-member/${id}`, { withCredentials: true })
      .then(async (response) => {
        ...
        <button
          ...
          onClick={async () => {
            if (window.confirm("Are you sure you want to delete this member?")) {
              try {
                await axios.delete(`${process.env.REACT_APP_API_URL}/members/${id}`, { withCredentials: true });
