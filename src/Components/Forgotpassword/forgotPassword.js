...
const ForgotPassword = () => {
    ...
    const changePassword = async () => {
        setLoader(true);   
        await axios.post(`${process.env.REACT_APP_API_URL}/auth/reset-password`, { email: inputField.email, newPassword: inputField.newPassword })
    .then((response) => {
    ...
    const sendOtp = async   () => {
        ...
        await axios.post(`${process.env.REACT_APP_API_URL}/auth/reset-password/sendOtp`, { email: inputField.email }).then((response) => {
             setEmailSubmit(true);
    ...
    const verifyOtp = async () => {
        setLoader(true);
        await axios.post(`${process.env.REACT_APP_API_URL}/auth/reset-password/checkOtp`, { email: inputField.email, otp: inputField.otp }).then((response) => {
            setOtpValidate(true);
